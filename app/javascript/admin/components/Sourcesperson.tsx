...
class Sourcesperson extends React.Component<{}, IState> {
  public state = {
    search: '',
  ...
  public render() {
    return (
      <div style={{ padding: '15px 0 40px 0' }}>
        <Authorize permissions={['sourcesperson:edit']}>
        ...
        <h2 className={Classes.HEADING}>Moje výroky</h2>
